...
namespace Renderer
{
	...
	public:
		...
		inline void DrawCoalBox(int x, int y, int w, int h, BYTE Red, BYTE Green, BYTE Blue, BYTE Alpha)
		{
			...
			// top
			DrawLine(x, y, x + iw, y, Red, Green, Blue, Alpha);			// left
			DrawLine(x + w - iw, y, x + w, y, Red, Green, Blue, Alpha);			// right
			DrawLine(x, y, x, y + ih, Red, Green, Blue, Alpha);				// top left
			DrawLine(x + w, y, x + w, y + ih, Red, Green, Blue, Alpha);	// top right
																// bottom
			DrawLine(x, y + h, x + iw, y + h, Red, Green, Blue, Alpha);			// left
			DrawLine(x + w - iw, y + h, x + w, y + h, Red, Green, Blue, Alpha);	// right
			DrawLine(x, y + h - ih, x, y + h, Red, Green, Blue, Alpha);			// bottom left
			DrawLine(x + w, y + h - ih, x + w, y + h, Red, Green, Blue, Alpha);	// bottom right
